...
lib/munit/: Integrated µnit testing framework core.
tests/: Test execution suites and behavioral test cases.
initial_processes.txt: Static boot-up workload.
arriving_processes.txt: Runtime dynamically arriving workload.
...
Quick Start
To configure your local environment and run the complete pipeline with a single command:
sh runme.sh
